...
class SharePointUtils:
    """Wrapper class for SharePoint operations to match expected interface"""
    
    def __init__(self):
        """Initialize SharePoint client"""
        self.client = SharePointClient()
        self.site_url = self.client.site_url
    ...
    def list_files(
        ...
        if file_types:
            ...
            for file in files:
                ...
                if file_ext in [ft.lower().strip('.') for ft in file_types]:
                    filtered_files.append(file)
            files = filtered_files
        
        # Format for expected interface
        return [
            {
                'id': file.get('id', ''),
                'name': file.get('name', ''),
                ...
                'modified_date': file.get('modified', ''),
    ...
    def get_file_properties(self, file_id: str) -> Dict[str, Any]:
        """Get file properties"""
